      ...
      <g transform="matrix(1.25,0,0,-1.25,0,47.5)">
        <g>
          <g clipPath="url(#clipPath16)">
            <g transform="translate(35.9346,10.3232)">
              <path
            ...
            <g transform="translate(35.9346,16.1406)">
              <path
                d="m 0,0 c 0,6.651 -7.597,12.042 -16.967,12.042 -9.371,0 -16.968,-5.391 -16.968,-12.042 0,-6.649 7.597,-8.162 16.968,-8.162 C -7.597,-8.162 0,-6.649 0,0"
                fill="#662113"
                fillOpacity="1"
            ...
            <g transform="translate(20.167,10.5488)">
              <path
            ...
            <g transform="translate(35.9346,21.9585)">
              <path
            ...
            <g transform="translate(10.7417,28.9761)">
              <path
            ...
            <g transform="translate(21.627,31.813)">
              <path
            ...
            <g transform="translate(32.208,22.7251)">
              <path
            ...
            <g transform="translate(27.7422,27.9761)">
              <path
            ...
            <g transform="translate(12.7422,20.9766)">
              <path
            ...
            <g transform="translate(16.9395,27.5859)">
              <path
            ...
            <g transform="translate(23.7422,20.9766)">
              <path
            ...
            <g transform="translate(6.0576,26.6646)">
              <path
